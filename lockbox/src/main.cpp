...
int main(int argc, char *argv[]) {
    ...
    cli_app.add_option("--key_provider", key_provider, "Key provider (google_kms, hashicorp or filesystem)")
        ->required()  // Mark it as mandatory
        ->check(CLI::IsMember({"google_kms", "hashicorp", "filesystem"}));  // Validate allowed values
